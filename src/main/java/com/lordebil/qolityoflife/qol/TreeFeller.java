...
public class TreeFeller {
    ...
    public static void fellTree(BlockPos pos, World world, Block block) {
        ...
        block.dropXpOnBlockBreak(world, startPos, Constants.WOOD_EXP_DROP_AMMOUNT * blocksBrokenAfterBreakEvent);
    }
    ...
    private static void checkBlockAndBreak(BlockPos blockPos, World world) {
        ...
        boolean shouldBlockBreak = Helper.blockIsType(block, Constants.LOGS) || Helper.blockIsType(block, Constants.LEAVES);
        if (shouldBlockBreak) {
